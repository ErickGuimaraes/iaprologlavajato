...
condenadocrime(ediel_viana_da_silva,uso_documentos_falsos).
...
condenadocrime(gim_argello,obstrucao_investigacao).
...
condenadocrime(jose_dirceu,recebimento_vantagem_indevida).
...
condenadocrime(raul_henrique_srour,operacao_fradulenta).
